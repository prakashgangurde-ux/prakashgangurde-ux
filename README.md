...
**BCA Final Year Student · Developer · Cybersecurity Enthusiast · Technical Content Creator**
...
prakash = {
    ...
    "open_to"    : ["Collaborations", "Freelance Writing", "Open Source"],
}
```
...
![AES Encryption](https://img.shields.io/badge/AES--256-Encryption-6366f1?style=flat-square)
...
### 🛡️ [AI Network Intrusion Detection](https://github.com/prakashgangurde-ux/AI-Based-Network-Intrusion-Detection)
ML-powered IDS using **Random Forest** and Explainable AI. Trained on CICIDS2017 dataset for real-time PortScan detection.
...
### 🅿️ [Smart Parking System](https://github.com/prakashgangurde-ux/smart-parking-system)
Full-stack platform with **QR code gate access**, real-time **WebSocket** notifications, and JWT authentication.

`FastAPI` `React` `MySQL` `WebSocket`
...
### 🔐 [File Encryption Vault](https://github.com/prakashgangurde-ux/File-Encrpt)
Offline vault using **AES-256** encryption, **PBKDF2** key derivation, password recovery, and full audit logging.

`Python` `AES-256` `PBKDF2` `Cryptography`

</td>
<td width="50%">

### 💨 [Secure Vault](https://github.com/prakashgangurde-ux/Secure-Vault)
Ephemeral storage for secure notes and files with **Firebase TTL** and automatic self-destruct on expiry.

`HTML` `Firebase` `Firestore` `Auth`
...
### 🤖 [TrackSmart-AI](https://github.com/prakashgangurde-ux/TrackSmart-AI)
Desktop productivity app with location tracking, notes, reminders, and **AI-powered recommendations**.

`Python` `SQLite` `Tkinter` `AI`

</td>
<td width="50%">

### ⌨️ [Keylogger (Educational)](https://github.com/prakashgangurde-ux/Keylogger)
Built to learn **event-driven programming**, multithreading, and GUI development. Educational use only.

`Python` `pynput` `Tkinter` `Threading`
...
*"Understanding systems from both the offensive and defensive side."*
